...
def solve_it(input_data):
    ...
    for N in neighbor_count: # (node, count)  [('10', 10), ('4', 9), ('2', 9), ('11', 9), ('9', 9),]
        ...
        if (None in table[N[0]]): # 1st pass will always have None
            ...
            table[N[0]][i] =  i # replace with index, push everything by +1
            table[N[0]] += [None]
...
if __name__ == '__main__':
    import sys
    file_location = "C:/Users/paul kuria/Documents/coloring/data/gc_70_1" #gc_20_1, gc_4_1, gc_20_3, gc_20_7, gc_50_7,gc_50_9, gc_1000_7
